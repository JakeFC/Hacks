...
class Game:
    ...
    def __init__(self):
        ...
        self.background = GameObject(0, 0, self.width, self.height, 'assets/test1.png')
    ...
    def reset_map(self):
        ...
        speed = (self.height / 360) * (self.level * 5)
        ...
        self.player = Player((self.width / 2) - (self.entity_width / 2), (self.height / 1.09), self.entity_width, self.entity_height, 'assets/player.png', (self.height / 180) + speed / (self.height / 60))
